...
class GraphDrawer extends HTMLElement {
    ...
    constructor() {
        ...
        var container = this;
        var graph = new Graph();
        var nodeParamsRenderer = DEFAULT_NODE_PARAMS_RENDERER;
        this.setupVariables(container, graph, nodeParamsRenderer);
    ...
    updateNodeElementCoords(nodeData) {
